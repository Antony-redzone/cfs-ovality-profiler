...
#include "qedit.h"
//#include <fstream> // PCN4896 #include <fstream.h>
#include <dshow.h>
...
//	int getframe(); PCN3284
	...
	void WriteDataToBMPFile(char *fileName, unsigned char *data, int width, int height);
	int CreateBMPFile(int width, int height);
	void CreateBMPFile(unsigned char *data, int width, int height, unsigned char *fileData);
};
